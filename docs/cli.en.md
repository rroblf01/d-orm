...
| `--check` (3.3+) | exit code 1 when the autodetector would write a migration; nothing is written. Wire into CI to catch model changes that ship without the matching migration |
